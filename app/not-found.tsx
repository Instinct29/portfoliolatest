      ...
      <Container width="reading">
        <div className="flex min-h-[60vh] flex-col justify-center">
          ...
          <p className="mt-3 max-w-md leading-relaxed text-muted-foreground">
            The link may be broken, or the page may have moved since it was written down.
          </p>
          ...
          <nav aria-label="Other pages" className="mt-10 border-t border-border pt-5">
            <p className="font-mono text-2xs uppercase tracking-label text-subtle">Or try</p>
